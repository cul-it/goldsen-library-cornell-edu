	...
	<div id="main">
		...
		<div id="main-content">
			...
			<div id="video">
				<div id="video-tabs">
					<ul>
						<li><a href="video_small.php?f=<?php echo($current_film); ?>" class="tab-on" title="Video">Video Main</a></li>
					...
					<div id="flash-content">
						<div id="column1">
							<div id="video-title">
								...
								<p>DVD <?php echo($meta["DIRECTORY"]); ?>:Segment <?php echo($meta["SEGMENT"]); ?></p>
								<p>Duration: <?php echo($meta["INTERVAL"]); ?></p>	
								<p>Performers: <?php echo($meta["PARTICIPANTS"]); ?></p>
								<p><?php echo($meta["GEOGRAPHIC_COVERAGE"]); ?>, c.<?php echo($meta["TEMPORAL_COVERAGE"]); ?></p>
							</div>
