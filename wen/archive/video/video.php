	...
	<div id="main">
		...
		<div id="main-content">
			...
			<div id="video">
				<div id="video-tabs">
					<ul>
						<li><a href="video.php?f=<?php echo($current_film); ?>" class="tab-on" title="Video">Video Main</a></li>
						<li><a href="video_large.php?f=<?php echo($current_film); ?>" title="Expanded Video">Expanded Video</a></li>
					</ul>
				</div>
					...
					<div id="flash-content">
						<div id="column1">
							<div id="video-title">
								...
								<?php if ($meta["GEOGRAPHIC_COVERAGE"]!="" && $meta["TEMPORAL_COVERAGE"]!="") { ?><p class="info"><?php echo($meta["GEOGRAPHIC_COVERAGE"]); ?>, circa.<?php echo($meta["TEMPORAL_COVERAGE"]); ?></p><?php } ?>
							</div>
						...
						if(hasRightVersion) {  // if we've detected an acceptable version
							...
							+ '<param name="FlashVars" value="fvFilm=<?php print $current_film_text?>" />'
							+ '<embed src="wp_player.swf" FlashVars="fvFilm=<?php print $current_film_text?>" quality="high" bgcolor="#000000" '
