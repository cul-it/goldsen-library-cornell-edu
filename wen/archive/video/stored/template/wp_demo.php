...
<br />
<P><a href="wp_demo.php">Different Film...</a></P>
...
?>
<tr>
  <td><a href="wp_demo.php?f=<?= $film[$i]["filmID"] ?>&l=eng"><?= $film[$i]["eng"] ?></a></td>
  <td><a href="wp_demo.php?f=<?= $film[$i]["filmID"] ?>&l=deu"><?= $film[$i]["chi"] ?></a></td>
</tr>
<?php
}
?>
